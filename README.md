...
This Project is built using [next.js](https://nextjs.org) (A framework build on top of react.js) and for css it uses [tailwindCSS](https://https://tailwindcss.com) for global state management it uses
