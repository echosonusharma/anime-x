...
const Anime = ({ animeInfo }) => {
  const {
    mal_id, image_url, title, title_japanese,
    type, episodes, status, aired, duration,
    rating, score, synopsis, studios, genres,
  } = animeInfo;
  ...
  return (
    <div className="mx-36">
        ...
        <div className="flex mt-20 gap-5">
          <div className=" flex gap-10 w-3/5 pb-5  bg-gray-100 rounded-xl">
            <div className="pl-10 py-10">
              <Image src={image_url} width={240} height={380} quality={80} className="rounded-lg" priority="eager" />
            </div>
      ...
      <Bookmark mal_id={mal_id} score={score} title={title} image_url={image_url} />
