      ...
      <div className="mx-48 pt-52">
        <div className="flex justify-center items-center">
          <div className="flex items-center gap-5">
            ...
            <h1 className="text-3xl text-gray-500 font-semibold">{data.message}</h1>
          </div>
        </div>
      </div>
    );
    ...
    return (
      <div className="mx-48 pt-52">
        <div className="flex justify-center items-center">
          <div className="flex items-center gap-5">
            <Image src="/static/warning.svg" width={50} height={50} priority="eager" />
            <h1 className="text-3xl text-gray-500 font-semibold">Unable to fetch data</h1>
          </div>
        </div>
      </div>
    );
      ...
      <div className="grid grid-cols-2 gap-4 ">
        {
          data.results?.map((items) => {
            const {
              mal_id, synopsis, title, image_url, episodes, start_date, end_date, score,
            } = items;
            return (
