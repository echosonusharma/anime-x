...
const Watched = () => {
  ...
  const handelGetPlaned = async () => {
    const x = await fetch('https://animex-backend.herokuapp.com/api/anime/get_watched', {
      method: 'POST',
      body: JSON.stringify({
      ...
      <div className="mx-48 pt-52">
        <div className="flex justify-center items-center">
          <div className="flex items-center gap-5">
            ...
            <h1 className="text-3xl text-gray-500 font-semibold">Login to View Watched</h1>
          </div>
        </div>
      </div>
    );
